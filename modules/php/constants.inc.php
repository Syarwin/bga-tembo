...
const ST_PRE_TURN_BOARD_TILE = 14;
...
const SPACE_DESTINATION_NORMAL = 15;
...
const EVENT_TYPE_IMMEDIATE = 0;
const EVENT_TYPE_PERSISTENT = 1;

const EVENT_EFFECT_TREE_2_ENERGY = 0;
const EVENT_EFFECT_TREE_LAY = 1;
const EVENT_EFFECT_OASIS = 2;
const EVENT_EFFECT_LOSE_2_ELEPHANTS = 3;
const EVENT_EFFECT_ROUGH_TERRAIN = 4;
const EVENT_EFFECT_DO_NOT_IGNORE_ROUGH_TERRAIN = 5;
const EVENT_EFFECT_LOSE_SUPPORT = 6;
const EVENT_EFFECT_LION_ACTIVATES = 7;
const EVENT_EFFECT_ELEPHANT_DIES = 8;
const EVENT_EFFECT_LIONS_LAY = 9;
const EVENT_EFFECT_ENERGY = 10;
const EVENT_EFFECT_NO_CARD_ROTATION = 11;
