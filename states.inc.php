...
$machinestates = [
  ...
  ST_USE_CARD => [
    'name' => 'useCard',
    'description' => clienttranslate('${actplayer} must select a card to build savanna or to place elephants'),
    'descriptionmyturn' => clienttranslate('${you} must select a card to build savanna or to place elephants'),
    'descriptionmatriarch' => clienttranslate('${actplayer} must select a card to build savanna, to place elephants or to play their matriarch card'),
    'descriptionmyturnmatriarch' => clienttranslate('${you} must select a card to build savanna, to place elephants or to play your matriarch card'),
    'type' => 'activeplayer',
    'args' => 'argsAtomicAction',
    'action' => 'stAtomicAction',
    'possibleactions' => [
